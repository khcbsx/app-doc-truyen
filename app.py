...
st.title("📚 Chuyển Đổi Truyện Chữ Sang Audio (Tối Ưu MP3)")
...
if uploaded_file:
    ...
    if st.session_state.chapter_list:
        ...
        with col3: 
            ...
            batch_size = st.number_input("Gộp X chương/file:", min_value=1, max_value=100, value=1)
        ...
        st.markdown("---")
        if st.button("🚀 Bắt Đầu Chuyển Thể Toàn Bộ (Ép Dung Lượng)", type="primary", use_container_width=True):
            ...
            for idx, batch in enumerate(batches):
                ...
                try:
                    if voice_info["engine"] == "edge":
                        ...
                        piper_speed = 1.0 / speed
                        temp_wav = os.path.join("output", f"temp_{batch_name}.wav")
